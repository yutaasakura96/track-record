 ...
 *
 * **Runtime-agnostic on purpose.** Nothing here imports `cloudflare:test`, so
 * `scripts/dev-session.ts` runs the same issuer under Node to sign a local
 * browser in (`docs/06`, 2026-09-25). The suite's wiring is `./oidc.ts`.
 */
